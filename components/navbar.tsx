        ...
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center">
            <div className="relative h-8 w-8 mr-2">
              <Image src="/images/logo.png" alt="Luvsmith Corp Logo" fill className="object-contain" />
            </div>
          ...
          <nav className="hidden md:flex items-center space-x-1 lg:space-x-2">
            ...
            <div className="ml-2 lg:ml-4 flex space-x-2">
              <Button size="sm" variant="outline" className="text-xs lg:text-sm" onClick={handleContactClick}>
                Get Started
              </Button>
              <Button size="sm" className="text-xs lg:text-sm" onClick={handleContactClick}>
                Become a Partner
              </Button>
            </div>
          </nav>
          ...
          <div className="md:hidden mt-4 pb-4 bg-white dark:bg-gray-900 rounded-lg shadow-lg animate-in slide-in-from-top-5 duration-300">
            <nav className="flex flex-col space-y-1">
              ...
              <div className="pt-3 px-4 flex flex-col space-y-2">
                <Button size="sm" variant="outline" className="w-full justify-center" onClick={handleContactClick}>
                  Get Started
                </Button>
                <Button size="sm" className="w-full justify-center" onClick={handleContactClick}>
                  Become a Partner
                </Button>
              </div>
            </nav>
