    ...
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <div ref={ref} className="max-w-4xl mx-auto text-center">
          ...
          >
            At Luvsmith Corp, we believe that technology should work for you, not against you. Since 2023, our team of
            experts has been dedicated to providing tailored IT solutions that help your business thrive in the digital
            landscape.
          </p>
