                ...
                {[
                  {
                    ...
                    description:
                      "Earn competitive rates for each connection you manage, with bonuses as you reach higher badge levels.",
                  },
                  {
                    title: "Flexible Schedule",
                    description: "Work on your own terms and manage your connections according to your schedule.",
                  },
                  {
                  ...
                  {!isSubmitted ? (
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-500 mt-2">
                            By submitting this form, your application will be sent to our WhatsApp support at
                            091-23-032-034.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 mb-6">
                        Thank you for your interest in joining our network. Your application has been sent to our
                        WhatsApp support.
                      </p>
